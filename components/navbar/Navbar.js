...
export default function Navbar() {
	...
	return (
		<div
			className={`w-full fixed top-0 left-0 flex justify-between z-50 backdrop-filter backdrop-blur-lg ${
		...
		>
			<div className="w-auto inline-flex items-center px-4">
				<img src="auxroadlogo.png" className="h-8 lg:h-10 w-auto md:m-4" />
				<MenuItems
